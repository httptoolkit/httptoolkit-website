...
* Load the page afresh, this time returning edited headers (directly from your server, or by adding a breakpoint from the [Modify page](/docs/reference/modify-page/) in HTTP Toolkit) that include `Accept-CH: UA-Platform`
