...
* $1160 to [anonrig](https://github.com/anonrig)
* $160 to [johnnyreilly](https://github.com/johnnyreilly)
* $160 to [blakeembrey](https://github.com/blakeembrey)
* $160 to [szmarczak](https://github.com/szmarczak)
* $160 to [lpinca](https://github.com/lpinca)
* $160 to [apocas](https://github.com/apocas)
* $160 to [regolith](https://opencollective.com/regolith)
* $160 to [endoflife-date](https://opencollective.com/endoflife-date)
* $160 to [react-window](https://opencollective.com/react-window)
* $160 to [fast-xml-parser](https://opencollective.com/fast-xml-parser)
* $160 to [tauri](https://opencollective.com/tauri)
* $160 to [node-datachannel](https://opencollective.com/node-datachannel)
* $160 to [ajv](https://opencollective.com/ajv)
* $160 to [styled-components](https://opencollective.com/styled-components)
* $160 to [mochajs](https://opencollective.com/mochajs)
* $160 to [electron](https://opencollective.com/electron)
* $160 to [mobx](https://opencollective.com/mobx)
* $160 to [openapi-directory](https://opencollective.com/openapi-directory)
* $140 to [phosphor-icons](https://github.com/phosphor-icons)
