...
<Accordion
  ...
  items={[
    ...
    {
      title: 'How do Enterprise accounts work?',
      text: "Enterprise accounts are for organizations with advanced team & purchase management needs, going beyond simple credit card subscriptions and manual team license configuration.\n\nEnterprise accounts include all paid product feature, plus:\n\n- **Payment by invoice and bank transfer** with no credit cards or recurring subscriptions.\n- **Support with procurement & compliance processes** to help navigate internal purchasing and approval requirements.\n- **SSO & SCIM integrations** to allow managing team access & membership through existing identity providers.\n- **Custom legal agreements**, for organizations that require tailored contract terms.\n- **Priority product support** to ensure your team gets fast, dedicated help when needed.\n\nEnterprise accounts are billed annually and require a minimum annual spend. To discuss creating an Enterprise account for your organization please [get in touch](/contact/).",
    },
    {
